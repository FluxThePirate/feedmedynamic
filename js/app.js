...
angular.module('app', ['ngMessages', 'ui.router']).config(function ($urlRouterProvider, $urlMatcherFactoryProvider, $httpProvider, $sceDelegateProvider, $locationProvider, $compileProvider) {
